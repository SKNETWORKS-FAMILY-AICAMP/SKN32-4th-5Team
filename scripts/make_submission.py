...
GROUPS: list[dict] = [
    {
        "dir": "01_데이터-전처리",
        "원본": "`docs/archive-3rd/01*.md` · `docs/01d·01e` · `data/facts/` · `data/manifests/`",
        "요구": "수집된 데이터 및 데이터 전처리 문서",
        "핵심": "01_데이터-수집및전처리.md",
        "한줄": "원문을 옮기지 않고 사실을 옮겼다 — 수집 전 게이트 · 사실 표 888행 · 삭제 이력",
        "items": [
            "docs/archive-3rd/01_데이터-수집및전처리.md",
            "docs/archive-3rd/01a_자료분석보고.md",
            "docs/archive-3rd/01b_자료검증보고.md",
            "docs/archive-3rd/01c_데이터-작업지시.md",
            "docs/01d_자료보관규칙.md",
            "docs/01e_사실표작성지침.md",
    ...
    },
    {
        ...
        "items": [
            "docs/02_시스템-아키텍처.md",
            "docs/archive-3rd/시스템설계_한장.pdf",
            "docs/archive-3rd/시스템설계_한장.html",
    ...
    {
        "dir": "04_테스트-결과보고서",
        "원본": "`docs/archive-3rd/04·04b` · `docs/04a` · `eval/`",
        "요구": "테스트 계획 및 결과 보고서",
        "핵심": "04_테스트-평가계획.md · 2026-08-04_결과보고서.md",
        "한줄": "골든셋 60건 · 다섯 판 측정 · 통과 45.0% → 65.0% · 중대 과소평가 0건",
        "items": [
            "docs/archive-3rd/04_테스트-평가계획.md",
            "docs/04a_골든셋작성지침.md",
            "docs/archive-3rd/04b_발견_근거검증과출처분해.md",
    ...
    },
    {
        ...
        "items": [
            "README.md",
            "docs/archive-3rd/00_기획-요구사항분석.md",
            "docs/archive-3rd/03_모델-멀티태스크학습.md",
            "docs/archive-3rd/03a_파인튜닝-구현기획.md",
            "docs/05_설계원칙-코드와LLM의분업.md",
            "docs/06_설계결정기록.md",
            "docs/archive-3rd/07_작업배분.md",
            "docs/09_새환경-준비.md",
            "docs/도메인검토-반려동물-헬스케어.md",
            "docs/archive-3rd/현재상태_2026-08-03.md",
            "docs/archive-3rd/08_코드검토",
        ],
    },
]
