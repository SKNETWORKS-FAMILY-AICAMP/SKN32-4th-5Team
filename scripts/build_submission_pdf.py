...
| **테스트** | `tests/` 682건 (Django 앱 16 포함) · `eval/` 골든셋 60건 |
...
지금 기능 요구사항 47건 중 **● 가 22건 · ◐ 가 24건**이다. 웹 화면 코드가 오래 CI 밖에
있었고, 2026-08-27 에 그중 아홉이 ● 로 옮겨 갔다 (`13_테스트계획.pdf` §5).
**아직 24건이 ◐ 라는 사실을 감추지 않는다.** 남은 일은 `14_전환설계.pdf` §5.4 의 7b-2 이후다.
"""
